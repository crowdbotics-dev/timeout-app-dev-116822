...
## Project Structure
    ...
    ├── timeout_app_dev_116822  # Django project configurations
...
1. Clone this repo and `cd timeout_app_dev_116822`
...
2. Clone this repo and `cd timeout_app_dev_116822`

"""
Django settings for timeout_app_dev_116822 project.
...
ROOT_URLCONF = 'timeout_app_dev_116822.urls'
...
WSGI_APPLICATION = 'timeout_app_dev_116822.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "timeout_app_dev_116822 API",
    "DESCRIPTION": "API documentation for timeout_app_dev_116822 App",
    "VERSION": "v1",
}
